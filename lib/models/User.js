...
var PersonalitySchema = new mongoose.Schema({
    // Describes the five personality traits
    openness: Number,
    extraversion: Number,
    neuroticism: Number,
...
var UserSchema = new mongoose.Schema({
    ...
    // personality will be an array of schemas containing the history
    // of their personality.  The last item will be their *current*
    // personality profile
    personality: [PersonalitySchema],
    
    // points are used to keep track of a user's ability to view profiles
    // and rate people
    points: {
        type: Number,
        'default': 0
    ...
    // keep track of users this user has rated
    //  NOTE: This is just an array of usernames (avoid circular refs)
    usersRated: [],
